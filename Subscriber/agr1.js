 ...
 *           Benjamin Fontaine
 *
 * @Description: Cette Classe constitue le premier aggréateur qui se charge du calcul de la moyenne de nombre de véhicule.
 * cette classe aggrege des données en temps reel ou bien a partir dun fichier local, en plus elle enregistre les données 
 * aggrégées dans une BD locale pour gérer la disponibilité. elle gére aussi le crash le crash et la latance.
 *
...
// we create 'moyenne' collection in newdb database
...
/////****** */ forcer le crash pour montrer la redandance passive *********////
...
/////////////////// fin de la fonction qui force le crash ////////////////////
